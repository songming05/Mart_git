	...
	<div class="col=md-12 col-sm-12 col-xs-12" id="bootCar"  style="margin-top:70px; width:1140px; height:150; min-width: 100%; min-height: 100%;">
            ...
            <ul class="carousel-inner"  style="width:1140px; height:150; min-width: 100%; min-height: 100%;">
                    <li  class="item active">
                    	 <a href="" class="col-md-4 col-sm-6 col-xs-12" style="width:380px; height:150; min-width:380px; min-height: 150px;">
                               <img src="../image/advertisement/main_advertise_Msize_img1.jpg" class="img-responsive center-block" alt="Some text">
                               
                         </a>
                    </li>
                    <li class="item">
                            <a href="../advertisement/minAd2" class="col-md-4 col-sm-6 col-xs-12" style="width:380px; height:150; min-width:380px; min-height: 150px;">
                    ...
                    <li class="item">
                        <a href="../advertisement/midAd1" class="col-md-4 col-sm-6 col-xs-12" style="width:380px; height:150;  min-width:380px; min-height: 150px;">
