...
<li class=""><a href="../mypage/myDeleteInfo">회원탈퇴</a></li>
    ...
    <ul class="column_tab column5 mt10">
        ...
        <li class="current"><a href="../mypage/myAsPage5">AS현황</a></li>
    </ul>
    <header class="positR pt30" id="reqAsListSection">
        <p class="fs12 fc_type6 bold ml10">AS신청 안내</p>
    ...
    <header class="positR pt30">
        <p class="fs12 fc_type6 bold ml10">AS 신청내역</p>
        <p class="positA r10 b0">
            <a href="" class="moveBtn on">온라인 AS내역</a>
            <a href="" class="moveBtn">오프라인 AS내역</a>
        </p>
    </header>
    <section class="mt10">
        ...
        <div class="tabs-content mt30">
            ...
            <div id="cm_tabs_01" class="tabs-cont basket_box">
                <div class="table_basic gallery_line_type1">
                    <table>
                        <colgroup>
                            <col width="120"><col width="120"><col width="*"><col width="140"><col width="110"><col width="80">
                        </colgroup>
                        <thead>
                            <tr>
                                ...
                                <th class="normal">AS유형</th>
                                <th class="normal">AS신청상태</th>
                                <th class="normal">재신청</th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr>
                                    <td colspan="6"><p class="non_data">AS 신청내역이 없습니다.</p></td>
                                </tr>
